...
internal partial record Manifest(ImmutableArray<Workload> Workloads, Workload? Active, [property: SerdeMemberOptions(SerializeNull = false)] string? ManifestPath = null)
{
