...
//        public string? DailyChannel { get; init; }
...
//                        "daily" => Channel.Daily,
//                        _ => throw new FormatException("Channel must be one of 'lts', 'current', 'preview', or 'daily'")
//                    },
//                    $"Download from the channel specified, Defaults to ${channel}.");
//                syntax.DefineOption("dc|daily-channel", ref dailyChannel, $"Daily channel to use when channel is 'daily'");
