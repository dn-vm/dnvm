...
namespace Internal.CommandLine
{
    internal sealed class ArgumentParser
    {
        ...
        public bool TryParseOptionList<T>(string diagnosticName,
            IReadOnlyCollection<string> names,
            Func<string, T> valueConverter,
            bool isRequired,
        ...
        private bool TryParseOptionArgument(ref int tokenIndex, bool isFlag, [NotNullWhen(true)] out string? argument)
        {
            argument = null;
        ...
        private bool TryGetNextToken(int tokenIndex, [NotNullWhen(true)] out ArgumentToken? token)
        {
