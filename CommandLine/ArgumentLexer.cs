...
namespace Internal.CommandLine
{
    internal static class ArgumentLexer
    {
        ...
        private static bool TryExtractOption(string text,
            [NotNullWhen(true)] out string? modifier,
        ...
        private static bool TryExtractOption(string text, string prefix,
            [NotNullWhen(true)] out string? modifier,
            [NotNullWhen(true)] out string? remainder)
        {
        ...
        private static bool TrySplitNameValue(string text,
